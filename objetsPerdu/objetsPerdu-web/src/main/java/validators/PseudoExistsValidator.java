...
@ManagedBean
@RequestScoped
public class PseudoExistsValidator implements Validator{
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException{
		...
		try{
			if( ! utilisateurService.recherchePseudo(pseudo)){
				throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Ce pseudo n'existe pas",null));
			}
		}catch(Exception ex){
